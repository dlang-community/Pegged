...
struct GenericD(TParseTree)
{
    ...
    static TParseTree AliasDeclaration(TParseTree p)
    {
        ...
        else
        {
            ...
            {
                TParseTree result = pegged.peg.named!(pegged.peg.and!(pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("alias"), Spacing), pegged.peg.wrapAround!(Spacing, pegged.peg.or!(pegged.peg.and!(pegged.peg.wrapAround!(Spacing, BasicType, Spacing), pegged.peg.wrapAround!(Spacing, Declarator, Spacing)), pegged.peg.wrapAround!(Spacing, List!(pegged.peg.wrapAround!(Spacing, AliasInitializer, Spacing)), Spacing)), Spacing)), "D.AliasDeclaration")(p);
    ...
    static TParseTree AliasInitializer(TParseTree p)
    {
        ...
        else
        {
            ...
            {
                TParseTree result = pegged.peg.named!(pegged.peg.and!(pegged.peg.wrapAround!(Spacing, Identifier, Spacing), pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("="), Spacing), pegged.peg.wrapAround!(Spacing, Type, Spacing)), "D.AliasInitializer")(p);
    ...
    static TParseTree AliasThisDeclaration(TParseTree p)
    {
        ...
        else
        {
            ...
            {
                TParseTree result = pegged.peg.named!(pegged.peg.and!(pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("alias"), Spacing), pegged.peg.wrapAround!(Spacing, pegged.peg.or!(pegged.peg.and!(pegged.peg.wrapAround!(Spacing, Identifier, Spacing), pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("this"), Spacing)), pegged.peg.and!(pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("this"), Spacing), pegged.peg.wrapAround!(Spacing, pegged.peg.literal!("="), Spacing), pegged.peg.wrapAround!(Spacing, Identifier, Spacing))), Spacing)), "D.AliasThisDeclaration")(p);
